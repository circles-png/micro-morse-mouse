...
fn main() {
    ...
    let port = new(selected_port, 115_200)
        .timeout(Duration::MAX) // Use a timeout of `Duration::MAX`.
        .open()
        .unwrap();
    ...
    loop {
        ...
        // Convert the data to a string. The processing stage of the IPO model starts here.
        ...
        // Move the mouse by the decoded amount. This is the output stage of the IPO model.
        mouse
            .move_to(
